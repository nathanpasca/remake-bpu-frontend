      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-8xl font-serif italic leading-[1.1] md:leading-[0.9] text-primary mb-8 tracking-tight">
            Berinvestasi pada Potensi, <br />
            <span className="not-italic font-bold text-accent block mt-4 text-3xl md:text-6xl uppercase tracking-tighter">Melalui Keunggulan Bisnis.</span>
          </h1>

          <p className="text-lg md:text-xl text-primary/70 max-w-lg mb-12 leading-relaxed font-medium">
            Mengoptimalkan Aset dan Mendukung Kemandirian Finansial Universitas Negeri Jakarta untuk Masa Depan yang Gemilang.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-8">
            ...
            <div className="text-xs font-black uppercase tracking-[0.2em] text-primary/30">
              Total Fasilitas:<br />
              <span className="text-accent text-lg">48 Lokasi</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="absolute -left-12 top-20 bg-accent p-8 w-72 shadow-2xl rotate-6 z-20">
            <div className="text-[10px] font-bold uppercase tracking-widest mb-1 opacity-60">Tersedia</div>
            <div className="font-serif text-3xl italic mb-6 text-primary">Sewa Fasilitas Kampus</div>
            <div className="flex justify-between items-center border-t border-primary/10 pt-4">
              <span className="bg-primary/10 px-2 py-1 text-[10px] font-bold rounded uppercase text-primary">BPU UNJ</span>
              <span className="font-bold text-primary">Aktif</span>
            </div>
          </div>
